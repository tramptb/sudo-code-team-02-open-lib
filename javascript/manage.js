    ...
    a.addEventListener('click', function (e) {
        ...
        function editBookModal(id) {
            ...
            fetch(`${infoAPI}/${id}`)
              ...
              .then(book => {
                ...
                document.querySelector('input[name="date-added"]').value = book['date added'];
                document.querySelector('input[name="date-expired"]').value = book['date expired'];
        ...
        function handleCreatForm(){
            ...
            creatBtn.onclick = function(){
                ...
                var dateExpired = document.querySelector('input[name="date-expired"]').value;
